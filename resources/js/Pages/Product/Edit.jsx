...
export default function Edit({ table, data }) {
    const [formData, setFormData] = useState({
        product_code: data.product_code || '',
        product_name: data.product_name || '',
        price: data.price || '',
        stock: data.stock || '',
        prod_customer_id: data.prod_customer_id || '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.put(`/products/${table}/update/${data.id}`, formData),{
    ...
    return (
        <div className="p-16">
            <h1 className="text-2xl font-bold mb-4 text-center">Edit Record</h1>
